 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://soapModel.training.edu/", wsdlLocation = "http://localhost:8080/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://soapModel.training.edu/", "CalculatorService");
    ...
    public training.wsdl.Calculator getCalculatorPort() {
        return super.getPort(new QName("http://soapModel.training.edu/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapModel.training.edu/", "CalculatorPort"), Calculator.class, features);
    }
