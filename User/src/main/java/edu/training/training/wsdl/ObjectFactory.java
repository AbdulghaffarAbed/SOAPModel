 ...
 * generated in the training.wsdl package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sub_QNAME = new QName("http://soapModel.training.edu/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://soapModel.training.edu/", "subResponse");
    private final static QName _Add_QNAME = new QName("http://soapModel.training.edu/", "add");
    private final static QName _Div_QNAME = new QName("http://soapModel.training.edu/", "div");
    private final static QName _DivResponse_QNAME = new QName("http://soapModel.training.edu/", "divResponse");
    private final static QName _Mul_QNAME = new QName("http://soapModel.training.edu/", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://soapModel.training.edu/", "mulResponse");
    private final static QName _AddResponse_QNAME = new QName("http://soapModel.training.edu/", "addResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: training.wsdl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapModel.training.edu/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapModel.training.edu/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapModel.training.edu/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapModel.training.edu/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapModel.training.edu/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapModel.training.edu/", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapModel.training.edu/", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapModel.training.edu/", name = "addResponse")
